        ...
        <form>
          ...
          <div className=' mt-8'>
            ...
            <div className="w-full mt-4">
              <select
                label={'Select ' + selectedProductType}
          ...
          <button type='button' className=" mt-8 bg-primary w-full rounded-md text-white py-2 text-sm hover:bg-green-500" onClick={handleApplyFilters}>Apply Filters</button>
        </form>
      </div>
    </div>
  );
